...
import dk.stamdata.parsers.fixedlengthparser.FLParserValue
import dk.stamdata.parsers.reference.{OneToManyReference}
import dk.stamdata.parsers.{StringConverter, Converter, ParseIf}
import dk.stamdata.parsers.fixedlengthparser.FixedLengthParserElement
